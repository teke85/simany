  ...
  return (
    ...
    >
      <div className="mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 flex font-[family-name:var(--font-lora)] flex-col items-start justify-center mb-8 md:mb-0">
          <h1 className="text-xl text-[#022461] lg:text-5xl tracking-normal text-start font-bold mb-4">
